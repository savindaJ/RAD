...
export default function Card(product: any) {
  return (
    <div style={{width:'300px'}} className="max-w-sm relative bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 watch-card">
      ...
      {/* <div className="inner-effect relative flex justify-center items-center">
        <button className="bg-blue-700 cart-button hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add TO Cart</button>
      </div> */}
    </div>
  );
}
