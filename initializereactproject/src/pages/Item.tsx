...
const people = [
  {
    name: "Jane jayasekara",
    title: "Regional Parasasasdigm Technician",
  ...
  {
    name: "John hemal",
    title: "Regional asasas Technician",
    department: "Optimization",
    role: "Tester",
  ...
  {
    name: "Veronica grambarge",
    title: "Regional ktssgrsva Technician",
    department: "Optimization",
...
export default function Item() {
  return (
    <div>
      ...
      <div className="flex flex-col container m-auto shadow-lg">
