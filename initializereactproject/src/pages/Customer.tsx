      ...
      <div className="flex flex-col">
        <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <section className="text-gray-600 body-font flex justify-content-end w-100">
              <button className="bg-blue-500 m-4 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add New Customer</button>
            </section>
            <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg container m-auto">
